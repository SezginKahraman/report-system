...
export default function ReportSystem() {
    ...
    useEffect(() => {
        ...
        fetchRoles();
        setTimeout(0);
    }, [selectedRole, currentPage, rolesPagination.page, rolesPagination.pageSize, searchTerm, sortConfig, userRolesPagination.page, userRolesPagination.pageSize, userSearchTerm, userSortConfig]);
