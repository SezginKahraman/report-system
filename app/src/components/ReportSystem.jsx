                      ...
                      >
                        ...
                        <td className="p-3 border">
                          <span className={`px-2 py-1 rounded ${
                            role.assigned ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                          }`}>
                        ...
                        <td className="p-3 border">
                          <span className={`px-2 py-1 rounded ${
                            role.eligible ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                          }`}>
                ...
                <tbody>
                  {filteredAndSortedUsers.map((user) => (
                    <tr key={user.id}>
                      ...
                      <td className="p-3 border">
                        <span className={`px-2 py-1 rounded ${
                          user.assignment ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                        }`}>
